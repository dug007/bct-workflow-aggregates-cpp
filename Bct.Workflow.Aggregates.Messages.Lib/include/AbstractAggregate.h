...
namespace Bct
{
   namespace Workflow
   {
      namespace Aggregates
      {
         ...
         public:
            /*!
             * Pure virtual function to return the current field set count for this aggregate. Implementers
             * should return increasing values each time this function is called. Users of this function
             ...
             * 
             * \return The field set counter incremented by 1 since that last time this function was called.
             */
