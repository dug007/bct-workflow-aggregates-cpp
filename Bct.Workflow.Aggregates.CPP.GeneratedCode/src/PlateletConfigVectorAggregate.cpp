...
#include "PlateletConfigVectorAggregate.h"
...
namespace Bct
{
   namespace Workflow
   {
      namespace Implementation
      {
         ...
         PlateletConfigVectorAggregate::PlateletConfigVectorAggregate(const std::string &version) :
            BaseAggregate(version),           
            postCellsPerMl(1, this),
         ...
         PlateletConfigVectorAggregate::~PlateletConfigVectorAggregate()
         {
         }

         void PlateletConfigVectorAggregate::bindMetaData()
         {
         ...
         AggregateMetaData PlateletConfigVectorAggregate::s_metaData;
         bool PlateletConfigVectorAggregate::s_initialized = false;
