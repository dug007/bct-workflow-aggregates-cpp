   ...
   namespace Workflow
   {
      namespace Implementation
      {
         ...
         void PlateletTemplateAggregate::bindMetaData()
         {
            ...
            {
               ComputeRule cr1("yieldId2", 2, "volumeMl yield $EnteredLater", "cellsPerMl volumeMl *");
               ComputeRule cr3("cellsPerMlId1", 1, "volumeMl cellsPerMl $EnteredLater yield cellsPerMl $EnteredLater &&", "yield volumeMl /");
               ComputeRule cr2("volumeMlId1", 0, "cellsPerMl volumeMl $EnteredLater yield volumeMl $EnteredLater &&", "yield cellsPerMl /");
